...
;	TRszer1 — kopia.c:62: licznik2=0;//tablica char ma wielkoœæ = 8
	mov	_licznik2,#0x00
00102$:
...
;	TRszer1 — kopia.c:76: licznik=0;//tablica char ma wielkoœæ = 8
	mov	_licznik,#0x00
00102$:
...
;------------------------------------------------------------
;------------------------------------------------------------
;	TRszer1 — kopia.c:91: void sio_int(void) __interrupt(4) // musi byæ 120-300 na sekunde
;	-----------------------------------------
;	 function sio_int
;	-----------------------------------------
_sio_int:
;	TRszer1 — kopia.c:93: if (TI)   {  //jeœli odebrano
